...
final appearanceSettings = [
            ...
            builder: (context) => AdaptiveAlertDialog(
              ...
              actions: [
                ...
                AdaptiveDialogAction(
                  ...
                  onPressed: () =>
                      Navigator.pop(context, allowedGoogleFonts.keys.toList()),
                ),
                AdaptiveDialogAction(
                  ...
                  onPressed: () async {
                    try {
                      ...
                      final ttfFolder = await Persistence.documentsDirectory
                          .dir(Persistence.fontsDir)
                          .create();
                    ...
                    child: CupertinoScrollbar(
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, i) => AdaptiveDialogAction(
                          onPressed: () =>
                              Navigator.pop(context, availableFonts[i]),
                          child: Text(
                            availableFonts[i],
                            style:
                                allowedGoogleFonts[availableFonts[i]]?.call() ??
                                TextStyle(fontFamily: availableFonts[i]),
                          ),
                        ),
                      ),
                    ),
    ...
    CustomMutableSettingWidget<SavedTheme>(
      ...
      builder: (theme, didModify) => Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Row(
            children:
                <(String, Color, ValueChanged<Color>, Color?)>[
                      (
                        'Primary',
                        theme.primaryColor,
                        ...
                        children: [
                            ...
                            builder: (context) => CupertinoButton(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: color.$2 == theme.primaryColor
                                        ? theme.barColor
                                        : theme.primaryColor,
                                  ),
                                  color: color.$2,
                          ...
                          Builder(
                            builder: (context) => SizedBox(
                              width:
                                  88 * Settings.textScaleSetting.watch(context),
                              height: 24,
                            ),
                          ),
                        ],
  ...
  SliderSettingWidget(
    ...
    enabledSetting: MappedSetting(
      ...
      (enabled) =>
          Settings.instance.thumbnailPixelation.abs() * (enabled ? 1 : -1),
    ),
  ),
  SliderSettingWidget(
  ...
  SegmentedSettingWidget(
    ...
    injectButton: (context, useGrid, setUseGrid) =>
        (ImageboardRegistry.instance.count > 1)
        ? Builder(
                ...
                adaptivePageRoute(
                  builder: (context) => SettingListPage(
                    ...
                    settings: ImageboardRegistry.instance.imageboards
                        .map(
                          (imageboard) => SegmentedSettingWidget(
          ...
          children: [
            ...
            DecoratedBox(
              ...
              child: ThreadRow(
                ...
                showLastReplies: Settings.showLastRepliesInCatalogSetting.watch(
                  context,
                ),
              ),
            ),
  ...
  PopupSubpageSettingWidget(
    ...
    preview: PanelSettingWidget(
      builder: (context) {
        ...
        final staggered = Settings.useStaggeredCatalogGridSetting.watch(
          context,
        );
  ...
  if (Platform.isAndroid && Settings.featureStatusBarWorkaround)
    const SwitchSettingWidget(
      ...
      setting: SettingWithFallback(
        Settings.useStatusBarWorkaroundSetting,
        false,
      ),
    ),
